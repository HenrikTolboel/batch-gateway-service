...
public class UserPermissionAddedEvent extends DomainEvent {
    private final UserId userId;
    private final PermissionRole permissionRole;

    public UserPermissionAddedEvent(final UserId userId, final PermissionRole permissionRole) {
        super();
        this.userId = userId;
    ...
    @JsonCreator
    UserPermissionAddedEvent(final @JsonProperty("domainEventId") DomainEventId domainEventId,
