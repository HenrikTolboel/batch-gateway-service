...
public final class KeyValueLMS extends Entity<UUID> implements KeyValueDetails {
    private final int size;
    private final KcvType kcvType;
    private final int kcvLength;
    private byte[] value;

    public KeyValueLMS(final @JsonProperty("size") int size,
    ...
    private KeyValueLMS(final KeyValueLMS other) {
        super(other.getId());
    ...
    @Override
    public KeyValueLMS clone() {
        return new KeyValueLMS(this);
    }
