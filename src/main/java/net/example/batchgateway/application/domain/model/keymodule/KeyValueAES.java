...
public final class KeyValueAES extends Entity<UUID> implements KeyValueDetails {
    private final int size;
    private final KcvType kcvType;
    private final int kcvLength;
    private byte[] value;

    public KeyValueAES(final @JsonProperty("size") int size,
    ...
    private KeyValueAES(final KeyValueAES other) {
        super(other.getId());
    ...
    @Override
    public KeyValueAES clone() {
        return new KeyValueAES(this);
    }
